...
2. Triển khai GitHub Action MVP theo phase 3.
3. Triển khai VS Code Extension MVP theo phase 4, có thể chạy song song phase 3.
4. Chưa bắt đầu OIDC trước khi phase 3 đạt exit criteria.
